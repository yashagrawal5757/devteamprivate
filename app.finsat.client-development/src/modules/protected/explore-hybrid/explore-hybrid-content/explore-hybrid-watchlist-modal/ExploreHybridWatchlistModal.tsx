...
import useExploreWatchlistModal from './hooks/useExploreWatchlistModal';
import ExploreWatchlistForm from './components/explore-watchlist-form/ExploreWatchlistForm';
...
const ExploreHybridWatchlistModal = () => {
    const {
...
export default ExploreHybridWatchlistModal;
